...
_soffice_path = r"E:\Installed\LibreOffice\program\soffice.exe"

## output dir
_output_dir = r"E:\Project\Job\GQ\Python\Baidu_downlaod_upload\Baidu_Pyqt5_Threading\document_merger\xfinal_version\module\temp"
...
def _convert_html_to_doc_and_add_image ( output_dir ):
    ...
    # time.sleep( 3 )
    # document = Document(new_doc_file)
    # index = 0
    # for paragraph in document.paragraphs:
    #     line = paragraph.text.strip()
    #
    ...
    #         if real_image_path:
    #             index += 1
    #             paragraph.text = paragraph.text.replace(f'IMAG_SRC_{index + 1}@@@{img_match}', '')
    #
    #
    #
    #
